...
TRANSLATIONS = {
    'en': {
        ...
        'chat_per_award': 'Messages per Award',
        'chat_award_col': 'Award',
        'chat_count_col': 'Messages',
        'chat_oldest_col': 'Oldest',
        'chat_newest_col': 'Newest',
        'chat_no_messages_db': 'No chat messages in database.',
        'chat_clean_by_award': 'Delete by Award',
        'chat_clean_by_award_info': 'Delete all messages for a specific award.',
        'chat_select_award': 'Select award',
        'chat_delete_award_btn': 'Delete messages for this award',
        'chat_clean_old': 'Delete Old Messages',
        'chat_clean_old_info': 'Delete messages older than a given number of days. Leave award blank to apply to all awards.',
        'chat_days_to_keep': 'Delete messages older than (days)',
        'chat_filter_award_optional': 'Filter by award (optional)',
        'chat_all_awards': 'All awards',
        'chat_delete_old_btn': 'Delete old messages',
        'chat_delete_all': 'Delete All Messages',
        'chat_delete_all_warning': 'This will permanently delete every chat message across all awards.',
    ...
    'es': {
        ...
        'chat_per_award': 'Mensajes por Concurso',
        'chat_award_col': 'Concurso',
        ...
        'chat_clean_by_award': 'Eliminar por Concurso',
        'chat_clean_by_award_info': 'Elimina todos los mensajes de un concurso específico.',
        'chat_select_award': 'Seleccionar concurso',
        'chat_delete_award_btn': 'Eliminar mensajes de este concurso',
        'chat_clean_old': 'Eliminar Mensajes Antiguos',
        'chat_clean_old_info': 'Elimina mensajes más antiguos que un número de días. Deja el concurso en blanco para aplicar a todos.',
        'chat_days_to_keep': 'Eliminar mensajes más antiguos de (días)',
        'chat_filter_award_optional': 'Filtrar por concurso (opcional)',
        'chat_all_awards': 'Todos los concursos',
        'chat_delete_old_btn': 'Eliminar mensajes antiguos',
        'chat_delete_all': 'Eliminar Todos los Mensajes',
        'chat_delete_all_warning': 'Esto eliminará permanentemente todos los mensajes de chat de todos los concursos.',
    ...
    'gl': {
        ...
        'chat_per_award': 'Mensaxes por Concurso',
        'chat_award_col': 'Concurso',
        ...
        'chat_clean_by_award': 'Eliminar por Concurso',
        'chat_clean_by_award_info': 'Elimina todas as mensaxes dun concurso específico.',
        'chat_select_award': 'Seleccionar concurso',
        'chat_delete_award_btn': 'Eliminar mensaxes deste concurso',
        'chat_clean_old': 'Eliminar Mensaxes Antigas',
        'chat_clean_old_info': 'Elimina mensaxes máis antigas que un número de días. Deixa o concurso en branco para aplicar a todos.',
        'chat_days_to_keep': 'Eliminar mensaxes máis antigas de (días)',
        'chat_filter_award_optional': 'Filtrar por concurso (opcional)',
        'chat_all_awards': 'Todos os concursos',
        'chat_delete_old_btn': 'Eliminar mensaxes antigas',
        'chat_delete_all': 'Eliminar Todas as Mensaxes',
        'chat_delete_all_warning': 'Isto eliminará permanentemente todas as mensaxes de chat de todos os concursos.',
